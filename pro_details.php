        ...
        <div class="box" style="padding-top: 60px;">
            <div  class="elements-alignment">
                ...
                <div class="text-center">
                    <h2 class="features-head text-left">Description</h2>
                    <p class="description_style"><?php echo $description;?></p>
                </div>


                <div class="products-alignment">
                    <img src="adminpage/<?php echo $main_image;?>" width="50%" class="pro_image_style" />
                    ...
                    <a href="enquiry.php"><button class="moreabout">Enquire Now</button></a>
                </div>
